...
(X_train, y_train), (X_test, y_test) = imdb.load_data(path=sys.argv[1],num_words=top_words)
...
y_proba = numpy.loadtxt('pred.txt')
#pred = keras.np_utils.probas_to_classes(y_proba)
